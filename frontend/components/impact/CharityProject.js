...
export default function CharityProject({ project, isActive }) {
  ...
  return (
    ...
    >
      <h3 className="text-heading-sm mb-2 text-neutral-900 dark:text-neutral-50">{project.title}</h3>
      <p className="text-body-sm text-neutral-700 dark:text-neutral-300 mb-4">{project.description}</p>
      ...
      <div className="space-y-4">
        ...
        <div className="flex justify-between items-center">
          ...
          <span className="text-ui text-primary-600 dark:text-primary-300">
      ...
      <div className="mt-6 flex gap-4">
        <button className="flex-1 px-4 py-2 bg-primary-800 hover:bg-primary-900 dark:bg-primary-600 dark:hover:bg-primary-700 text-white text-ui rounded-lg transition-colors">
          Donate Now
        </button>
        <button className="flex-1 px-4 py-2 border-2 border-primary-700 dark:border-primary-600 text-primary-700 dark:text-primary-200 hover:bg-primary-50 dark:hover:bg-primary-900/20 text-ui rounded-lg transition-colors">
          Learn More
        </button>
      </div>
    </div>
